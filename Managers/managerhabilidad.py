...
class habilidades:
     ...
     def agregar_habilidad (self, Habilidad:HabilidadModel, cursor:psycopg.Cursor):
     ...
     def actualizar_habilidad (self,id:int, Habilidad:HabilidadModel, cursor:psycopg.Cursor):

        cursor.execute ("UPDATE habilidad SET habilidad=%s WHERE id_habilidad=%s", (Habilidad.habilidad, id))
